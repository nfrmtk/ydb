...
Локальный Блум-индекс — частный случай [локального индекса](#local-index): вероятностный фильтр по значениям колонок на основе [фильтра Блума](https://ru.wikipedia.org/wiki/Фильтр_Блума), ускоряющий селективные запросы за счёт пропуска фрагментов данных, в которых искомое значение гарантированно отсутствует. Поддерживаются типы `bloom_filter` и `bloom_ngram_filter`. Подробнее: [Блум-индексы](../dev/bloom-skip-indexes.md), [локальные индексы](query_execution/local_indexes.md).
=======
#### Локальный min_max индекс {#local-min_max-index}

Локальный min_max индекс — частный случай [локального индекса](#local-index): 

{% include [min_max_concept.md](./datamodel/_includes/min_max_concept.md) %}

Подробнее: [min_max индекс](../dev/min_max-indexes.md), [локальные индексы](query_execution/local_indexes.md).

>>>>>>> 3b02e2a956b (intermediate)
