...
| `enable_local_bloom_filter_index`                        | [Локальный Блум-индекс](../../dev/bloom-skip-indexes.md) типа `bloom_filter` |
| `enable_local_bloom_ngram_filter_index`                  | [Локальный Блум-индекс](../../dev/bloom-skip-indexes.md) типа `bloom_ngram_filter` |
| `enable_local_min_max_index`                             | [Локальный min_max индекс](../../dev/min_max-index.md) |
